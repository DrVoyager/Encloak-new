...
void encall_switch_type_update2(void* data,void* rei,int* int_array,int int_tail,double* double_array,int double_tail,float* float_array,int float_tail,char* char_array,int char_tail,long* long_array, int long_tail,char* byte_array, int byte_tail,char* uuid,char* ouuid,char* cuuid) ;
int print_int(long line,int* int_array,char* uuid,char* ouuid,char* cuuid);
int print_int2(long line,int* int_array,char* uuid,char* ouuid,char* cuuid);
double print_double(long line,double* double_array,int* int_array,char* uuid,char* ouuid,char* cuuid);
float print_float(long line,float* float_array,char* uuid,char* ouuid,char* cuuid);
int print_char(long line,char* char_array,char* uuid,char* ouuid,char* cuuid);
